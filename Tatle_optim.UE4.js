...
var Module = {
	...
	UE4_indexedDBVersion: 202108141752, // Bump this number to invalidate existing IDB storages in browsers.
};
...
//	}
	...
	function withIndexedDB(db) {
		...
		// ----------------------------------------
		// MAIN JS
		var mainJsDownload = fetchOrDownloadAndStore(db, Module.locateFile('https://rawcdn.githack.com/AtomDixon/Table_pres/964f872f535a12ecbc1c8cc1329eeada2819f656/UE4Game.js'), 'blob').then(function(data) {
		...
		// ----------------------------------------
		// MORE JS
		var dataJsDownload = fetchOrDownloadAndStore(db, Module.locateFile('https://rawcdn.githack.com/AtomDixon/Table_pres/70bcb3e7705a269ae17d69375ccc50d24df6132b/Tatle_optim.data.js'));
		var utilityJsDownload = fetchOrDownloadAndStore(db, Module.locateFile('https://rawcdn.githack.com/AtomDixon/Table_pres/964f872f535a12ecbc1c8cc1329eeada2819f656/Utility.js')).then(addScriptToDom);
		var dataDownload =
